...
public:
	...
	virtual void SetTimeFromIndex(int index);//new
	...
	virtual void PoseIndex(int index);//new
	...
	virtual void AddNoise(bool noise_bef_rot = false, double min = 0, double max = 0, 
		double radian = 0, bool rot_vel_w_pose = false, bool vel_noise = false, double interp = 1, 
		bool knee_rot = false);
	...
	virtual void CalcIndexPose(int index, Eigen::VectorXd& out_pose) const;//new
	virtual void CalcIndexVel(int index, Eigen::VectorXd& out_pose) const; //new
...
private:
	virtual void AddNoisePoseVel(double min = 0, double max = 0); //new
	virtual void RandomRotatePoseVel(double radian = 0, bool rot_vel_w_pose = false, bool vel_noise = false, double interp = 1, bool knee_rot = false); //new
};