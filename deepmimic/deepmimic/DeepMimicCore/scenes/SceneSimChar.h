...
public:
	...
	virtual void UpdateCharactersSyncTimestep(double time_elapsed);//new
...
protected:
	...
	virtual void ResetSceneIndex(int index, bool resolve = true, bool noise_bef_rot = false, 
	...
	virtual void ResetSceneTime(double time, bool resolve = true, bool noise_bef_rot = false, 
		double min = 0, double max = 0, double radian = 0, bool rot_vel_w_pose = false, 
		bool vel_noise = false, double interp = 1, bool knee_rot = false);//new
	virtual void ResetCharactersIndex(int index, bool noise_bef_rot = false, double min = 0, 
		double max = 0, double radian = 0, bool rot_vel_w_pose = false, bool vel_noise = false, 
		double interp = 1, bool knee_rot = false);//new
	virtual void ResetCharactersTime(double time, bool noise_bef_rot = false, double min = 0, 
		double max = 0, double radian = 0, bool rot_vel_w_pose = false, bool vel_noise = false, 
		double interp = 1, bool knee_rot = false);//new
