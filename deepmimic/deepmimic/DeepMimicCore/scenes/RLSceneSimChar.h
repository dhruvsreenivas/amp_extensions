...
public:
	...
	virtual int GetAMPObsPoseSize() const;//new
	virtual int GetAMPObsVelSize() const;//new
	...
	virtual void RecordAMPObsAgentCurrent(int agent_id, Eigen::VectorXd& out_data); //new
	...
	virtual void GetDTWBacktrackPath(int agent_id, Eigen::VectorXd& out_data);//New
