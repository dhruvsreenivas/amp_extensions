...
int cRLSceneSimChar::GetAMPObsPoseSize() const
{
	return 0;
}

int cRLSceneSimChar::GetAMPObsVelSize() const
{
	return 0;
}
...
void cRLSceneSimChar::RecordAMPObsAgentCurrent(int agent_id, Eigen::VectorXd& out_data)
{
	out_data.resize(0);
}
...
void cRLSceneSimChar::GetDTWBacktrackPath(int agent_id, Eigen::VectorXd& out_data) {
	out_data.resize(0);
}
...
void cRLSceneSimChar::ResetSceneIndex(int index, bool resolve, bool noise_bef_rot, double min, double max, double radian, bool rot_vel_w_pose,
	bool vel_noise, double interp, bool knee_rot)
{
	cRLScene::ResetScene();
	cSceneSimChar::ResetSceneIndex(index, resolve, noise_bef_rot, min, max, radian, rot_vel_w_pose, vel_noise, interp, knee_rot);
}

void cRLSceneSimChar::ResetSceneTime(double time, bool resolve, bool noise_bef_rot, double min, double max, double radian, bool rot_vel_w_pose,
	bool vel_noise, double interp, bool knee_rot)
{
	cRLScene::ResetScene();
	cSceneSimChar::ResetSceneTime(time, resolve, noise_bef_rot, min, max, radian, rot_vel_w_pose, vel_noise, interp, knee_rot);
}
