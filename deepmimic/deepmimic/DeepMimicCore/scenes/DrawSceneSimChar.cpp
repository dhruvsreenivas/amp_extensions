...
void cDrawSceneSimChar::UpdateSyncTimestep(double time_elapsed)
{
	cDrawScene::Update(time_elapsed);

	UpdateSceneSyncTimestep(time_elapsed);
	if (mEnableTrace)
	{
		UpdateTracer(time_elapsed);
	}
...
void cDrawSceneSimChar::UpdateSceneSyncTimestep(double time_elapsed)
{
	ApplyUIForce(time_elapsed);
	mScene->UpdateSyncTimestep(time_elapsed);
}
...
void cDrawSceneSimChar::ResetSceneIndex(int index, bool resolve, bool noise_bef_rot, double min, double max, double radian, bool rot_vel_w_pose,
...
void cDrawSceneSimChar::ResetSceneTime(double time, bool resolve, bool noise_bef_rot, double min, double max, double radian, bool rot_vel_w_pose,
	bool vel_noise, double interp, bool knee_rot)
{
	cDrawScene::ResetScene();
...
double cDrawSceneSimChar::GetMotionLength() const
{
	return mScene->GetMotionLength();
}

double cDrawSceneSimChar::GetAgentUpdateRate(int agent_id) const
{
	return mScene->GetAgentUpdateRate(agent_id);
}

int cDrawSceneSimChar::GetStatePoseOffset(int agent_id) const
{
	return mScene->GetStatePoseOffset(agent_id);
}

int cDrawSceneSimChar::GetStatePoseSize(int agent_id) const
{
	return mScene->GetStatePoseSize(agent_id);
}

int cDrawSceneSimChar::GetStateVelOffset(int agent_id) const
{
	return mScene->GetStateVelOffset(agent_id);
}

int cDrawSceneSimChar::GetStateVelSize(int agent_id) const
{
	return mScene->GetStateVelSize(agent_id);
}

int cDrawSceneSimChar::GetStatePhaseOffset(int agent_id) const
{
	return mScene->GetStatePhaseOffset(agent_id);
}

int cDrawSceneSimChar::GetStatePhaseSize(int agent_id) const
{
