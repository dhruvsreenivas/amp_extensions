...
public:
	...
	virtual int GetAMPObsPoseSize() const = 0; //new
	virtual int GetAMPObsVelSize() const = 0; //new
	...
	virtual void RecordAMPObsAgentCurrent(int agent_id, Eigen::VectorXd& out_data) = 0; //new
	...
	virtual void GetDTWBacktrackPath(int agent_id, Eigen::VectorXd& out_data) = 0; //new
protected:
	eMode mMode;
	int mSampleCount;
