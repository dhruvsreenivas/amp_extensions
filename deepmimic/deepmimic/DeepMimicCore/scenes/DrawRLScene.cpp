...
int cDrawRLScene::GetAMPObsPoseSize() const
{
	return GetRLScene()->GetAMPObsPoseSize();
}

int cDrawRLScene::GetAMPObsVelSize() const
{
	return GetRLScene()->GetAMPObsVelSize();
}
...
void cDrawRLScene::RecordAMPObsAgentCurrent(int agent_id, Eigen::VectorXd& out_data)
{
	GetRLScene()->RecordAMPObsAgentCurrent(agent_id, out_data);
...
void cDrawRLScene::GetDTWBacktrackPath(int agent_id, Eigen::VectorXd& out_data) {
	GetRLScene()->GetDTWBacktrackPath(agent_id, out_data);
}
