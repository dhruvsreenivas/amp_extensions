...
void cDrawUtil::InitDrawUtil(std::string deepmimic_path)//new
{
	glewInit();
...
void cDrawUtil::BuildShaders(std::string deepmimic_path)
{
	{
		gDefaultProg.BuildShader(deepmimic_path + "data/shaders/Mesh_VS.glsl", deepmimic_path + "data/shaders/VertColor_PS.glsl");
	}

	{
		gCopyProg.BuildShader(deepmimic_path + "data/shaders/FullScreenQuad_VS.glsl", deepmimic_path + "data/shaders/DownSample_PS.glsl");
	}

	{
		gCopyMeshProg.BuildShader(deepmimic_path + "data/shaders/Mesh_VS.glsl", deepmimic_path + "data/shaders/DownSample_PS.glsl");
	}
}
