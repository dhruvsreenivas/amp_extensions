import deepmimic.learning.nets.fc_2layers_1024units as fc_2layers_1024units
import deepmimic.learning.nets.fc_2layers_gated_1024units as fc_2layers_gated_1024units
