...
from deepmimic.learning.path import *
from deepmimic.learning.exp_params import ExpParams
from deepmimic.learning.normalizer import Normalizer
from deepmimic.learning.replay_buffer import ReplayBuffer
        ...
        if (self.replay_buffer_initialized):  
            if (self._valid_train_step()):
                ...
                for i in range(iters):
                    ...
                    self.logger.log_tabular("Exploration rate", self.exp_params_curr.rate)
