...
import deepmimic.learning.nets.net_builder as net_builder
from deepmimic.learning.ppo_agent import PPOAgent
import deepmimic.learning.solvers.mpi_solver as mpi_solver
from deepmimic.learning.tf_normalizer import TFNormalizer
from deepmimic.learning.replay_buffer_rand_storage import ReplayBufferRandStorage
from deepmimic.util.logger import Logger
import deepmimic.util.math_util as MathUtil
import deepmimic.util.mpi_util as mpi_util
...
class AMPAgent(PPOAgent):
    ...
    def reset(self):
        ...
        #self.path.amp_obs_agent_current= []
        return
    ...
    def _record_amp_obs_current(self):
        obs_agent_features = self._record_amp_obs_agent_current()
        self.path.amp_obs_agent_current.append(obs_agent_features)
    ...
    def _record_amp_obs_agent_current(self):
        obs_agent_features = np.array(self.world.env.record_amp_obs_agent_current(self.id))
        return obs_agent_features
